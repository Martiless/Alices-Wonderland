"""
Django settings for alices_wonderland project.
...
ROOT_URLCONF = 'alices_wonderland.urls'
...
MESSAGAE_STORAGE = 'django.contrib.messages.storage.sessions.SessionStorage'
...
WSGI_APPLICATION = 'alices_wonderland.wsgi.application'
...
STRIPE_CURRENCY = 'EUR'
SRTIPE_PUBLIC_KEY = os.getenv('STRIPE_PUBLIC_KEY', '')
SRTIPE_SECRET_KEY = os.getenv('STRIPE_SECRET_KEY', '')
SRTIPE_WH_SECRET = os.getenv('STRIPE_WH_SECRET', '')
